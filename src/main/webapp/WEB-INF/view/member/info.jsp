...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-6">
            ...
            <div>
                <div class="mb-3">
                    <label for="inputEamil" class="form-label">
                        이메일
                    </label>
                    <input value="${member.email}" id="inputEamil" type="text" readonly="" class="form-control">
                </div>
                <div class="mb-3">
...
<div class="d-none" onsubmit="return confirm('탈퇴?')">
